  ...
  return (
    <section className="px-5 md:px-20 py-20">
      <div>
        ...
        <h4 className="text-4xl w-[60%] leading-[1.4] font-campton">
          We provide end-to-end EPC services that ensure the success of your
          projects
        </h4>
        <div className="mt-7">
          <div className="border border-solid rounded-full w-max px-2 py-2 border-[#E9E9E9]">
          ...
          <div className="flex items-center gap-8 mt-8">
            <Image
              src={ServiceImg}
              alt="Service"
              className="w-[35%] h-full max-w-[550px]"
              quality={100}
              width={1000}
              height={1000}
            />
            <div>
              <h3 className="text-3xl mb-2">Tech for sustainability</h3>
              <p className="text-base w-[80%] mb-6 leading-loose">
