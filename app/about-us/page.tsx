...
const AboutUsPage = () => {
  return (
    <>
      ...
      <section className="px-5 md:px-20 cover-bg py-20 text-white mb-20 mt-14">
        <div className="flex items-start text-accent text-xs font-campton-book mb-3 gap-1">
          <RiHomeLine className="font-black" />{" "}
        ...
        <h1 className="text-4xl leading-[1.3] mb-3 w-[40%]">
          Take A Brief{" "}
      ...
      <section className="main-text-sect px-5 md:px-20">
        ...
        <div className="mt-20">
          <h3 className="text-4xl leading-[1.3] mb-3 w-[60%]">
            Genuine
